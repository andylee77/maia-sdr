# 002 -- Phase 1: FPGA Gateware + Vivado Integration
...
Implemented the complete FPGA DSP pipeline: C4FM demodulator, Gardner symbol timing recovery, and dibit packer with DMA. Integrated into p25_top.py with DmaStreamWrite for PS dibit delivery. Updated Vivado project files and generated the SVD + Rust PAC.
...
- SVD generated via `generate_p25_svd.py` -> `p25-httpd/p25-pac/p25.svd`
...
- DEVPLAN.md updated accordingly
