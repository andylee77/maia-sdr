...
// Peak-scaled so max |coeff| = 131068 (Q1.17 max).
#[rustfmt::skip]
const P25_FIR1_COEFFS: &[i32] = &[
         54,     219,     545,    1096,    1830,    2620,    3176,    3112,
       1994,    -481,   -4329,   -9095,  -13786,  -16919,  -16745,  -11614,
       -422,   16985,   39554,   65029,   90241,  111646,  126010,  131068,
     126010,  111646,   90241,   65029,   39554,   16985,    -422,  -11614,
     -16745,  -16919,  -13786,   -9095,   -4329,    -481,    1994,    3112,
       3176,    2620,    1830,    1096,     545,     219,      54,       0,
];

// Stage 2 (FIR2DSP): 56 taps, pb=100 kHz, sb=250 kHz,
// -93 dB Parks-McClellan (fs = 2 MSPS, /4 -> 500 kSPS).
// Peak-scaled so max |coeff| = 131069 (Q1.17 max).
#[rustfmt::skip]
const P25_FIR2_COEFFS: &[i32] = &[
        -57,    -186,    -426,    -773,   -1162,   -1451,   -1432,    -888,
        316,    2130,    4232,    6017,    6695,    5495,    1957,   -3776,
     -10762,  -17257,  -20958,  -19478,  -10968,    5279,   28416,   55965,
      84148,  108583,  125187,  131069,  125187,  108583,   84148,   55965,
      28416,    5279,  -10968,  -19478,  -20958,  -17257,  -10762,   -3776,
       1957,    5495,    6695,    6017,    4232,    2130,     316,    -888,
      -1432,   -1451,   -1162,    -773,    -426,    -186,     -57,       0,
];

// Stage 3 (FIR4DSP): 104 taps, pb=10 kHz, sb=31.25 kHz,
// -90 dB Parks-McClellan (fs = 500 kSPS, /8 -> 62.5 kSPS).
// Peak-scaled so max |coeff| = 131071 (Q1.17 max).
#[rustfmt::skip]
const P25_FIR3_COEFFS: &[i32] = &[
        -32,      -4,      17,      63,     143,     267,     443,     679,
        978,    1338,    1748,    2189,    2632,    3037,    3357,    3537,
       3515,    3232,    2635,    1680,     343,   -1375,   -3444,   -5799,
      -8337,  -10918,  -13366,  -15477,  -17024,  -17769,  -17478,  -15937,
     -12962,   -8420,   -2239,    5578,   14950,   25707,   37600,   50304,
      63428,   76534,   89159,  100832,  111102,  119561,  125866,  129757,
     131071,  129757,  125866,  119561,  111102,  100832,   89159,   76534,
      63428,   50304,   37600,   25707,   14950,    5578,   -2239,   -8420,
     -12962,  -15937,  -17478,  -17769,  -17024,  -15477,  -13366,  -10918,
      -8337,   -5799,   -3444,   -1375,     343,    1680,    2635,    3232,
       3515,    3537,    3357,    3037,    2632,    2189,    1748,    1338,
        978,     679,     443,     267,     143,      63,      17,      -4,
        -32,       0,       0,       0,       0,       0,       0,       0,
];
